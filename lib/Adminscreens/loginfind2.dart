...
import 'package:prototype/Adminscreens/load_admin.dart';
      ...
      child: RaisedButton(
        ...
        onPressed: () {
          if (emailController != null &&
              emailController.text == "abc" &&
              passwordController != null &&
              passwordController.text == "123") {
            Navigator.of(context).push(new MaterialPageRoute(
                builder: (BuildContext content) => new FlutterSpinkitAdmin()));
          }
          ...
          if (emailController.text != "abc" &&
            ...
            setState(() {
              ...
              errormessage1 = "Please enter valid email and username";
            });
          }
        },
          ...
          child: Stack(
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage("img/2.png"), fit: BoxFit.cover)),
              ),
              Container(
                height: double.infinity,
